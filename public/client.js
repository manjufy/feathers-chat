  ...
  if(userList) {
    ...
    userList.innerHTML += `<li>
      <a class="block relative" href="#">
        ...
        <span class="absolute username">${escape(user && user.email)}</span>
      </a>
    </li>`;
...
const addMessage = message => {
  ...
  if(chat) {
    chat.innerHTML += `<div class="message flex flex-row">
      <img src="${user.avatar}" alt="${escape(user.email)}" class="avatar">
      <div class="message-wrapper">
        <p class="message-header">
          <span class="username font-600">${escape(user.email)}</span>
